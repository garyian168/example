...
Backup_Dir=("/bullet/www.zdt6.com") #网站目录
MYSQL_Dump="/usr/local/mysql/bin/mysqldump" #mysqldump目录位置
MYSQL_UserName="zdtshop888" #数据库用户名
MYSQL_PassWord="REprac3e"	#数据库密码
Backup_Database=("zdtshop888") #要备份的数据库
